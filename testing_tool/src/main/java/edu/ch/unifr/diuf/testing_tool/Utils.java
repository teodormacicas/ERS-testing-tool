...
{   
    ...
    public static final String CLIENT_PROGRAM_REMOTE_FILENAME = "transaction_client.jar";
    ...
    public static final String CLIENT_REMOTE_FILENAME_SUFFIX_READY_WARMUP = "-client-ready-for-warmup";
    ...
    public static String getClientRemoteDataFilename(Client c) {
        return c.getWorkingDirectory()+"/"+c.getInputFilename();
    }
